...
crontab headless example: 2 3 * * */bin/bash -l -c 'cd /home/basejumper | xvfb-run -a ruby /home/basejumper/scrape.rb MSP >/dev/null 2>&1' Scrape.rb requires an ITA departure airport code as a required argument. Mongodb, Postgresql and Orchestrate.io supported but not required. Currency converted to USD automatically.
